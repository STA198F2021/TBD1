...
```{r summary_stats}
depression_stats <- aggregate( depression ~ COUNTRY, new_set, mean )

anxiety_stats <- aggregate( anxiety ~ COUNTRY, new_set, mean )

ocd_stats <- aggregate( ocd ~ COUNTRY, new_set, mean )

insomnia_stats <- aggregate( insomnia ~ COUNTRY, new_set, mean )

therapy_stats <- aggregate( therapy ~ COUNTRY, new_set, mean )
