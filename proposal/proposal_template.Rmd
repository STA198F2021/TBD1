...
```{r US-reg, message=FALSE, warning=FALSE, echo=FALSE}
>>>>>>> 3bf33016f446c9bab7e57851bc3b50bc68c58567
US_data <- lim_set %>%
...
```{r s2, echo=FALSE, message=FALSE, echo=FALSE}
>>>>>>> 3bf33016f446c9bab7e57851bc3b50bc68c58567
...
```{r Brazil-reg, message=FALSE, warning=FALSE, echo=FALSE}
Brazil_data <- lim_set %>%
  filter(COUNTRY == "Brazil")
>>>>>>> 3bf33016f446c9bab7e57851bc3b50bc68c58567
...
```{r Mex-reg, warning = FALSE, message = FALSE, echo=FALSE}
Mexico_data <- lim_set %>%
  filter(COUNTRY == "Mexico")
>>>>>>> 3bf33016f446c9bab7e57851bc3b50bc68c58567
...
```{r New-reg, message=FALSE, warning=FALSE, echo=FALSE}
NewZealand_data <- lim_set %>%
  filter(COUNTRY == "New Zealand")
>>>>>>> 3bf33016f446c9bab7e57851bc3b50bc68c58567
...
```{r Ind-reg, message=FALSE, warning=FALSE, echo=FALSE}
India_data <- lim_set %>%
  filter(COUNTRY == "India")
>>>>>>> 3bf33016f446c9bab7e57851bc3b50bc68c58567
