...
ggplot(data = lim_set, mapping = aes(x = mdy(DATE_START), y = relative_ocd)) + geom_point() + geom_smooth() + ylim(0, 6) + xlab("Date (2020)") + ylab("Search requency for 'ocd', 1.0 = 2019 mean") + labs(title="Searches for OCD Spiked During First Covid Wave")
