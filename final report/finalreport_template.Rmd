...
Next to each residual plot is the corresponding scatter plot with the regression line fitted to the data. The significance of these relationships will be further explored numerically from the results of regression analysis. (???)
