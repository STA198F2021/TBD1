...
```{r -generate-final-regs, include = FALSE, message=FALSE, warning=FALSE, echo = FALSE}
##regression models used for deeper analysis
...
##All New Zealand Regression Models
...
|      Next to each residual plot is a corresponding scatter plot comparing the actual versus fitted values for each model.
