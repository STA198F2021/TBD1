...
```{r residualPlots, warning=FALSE, message=FALSE, echo = FALSE, fig.height = 3, fig.width = 3}
...
#TODO==>write a better intro for this that explains why we chose multiple regression and what that tells us, in general.
#TODO==>include plots with regression line on top of data and write a short paragraph talking about it.
