...
In order to conduct analysis, various combinations of mental health search term popularity were examined as explained by the index of public health measure severity. Mental health search term popularity was used as an indicator for what mental illness prevalence during a given time frame, and was analyzed alongside what restriction intensity for the same time frame. This relationship was explored across various countries in order to account for the differences in public health measures that each government enacted throughout the course of the pandemic, as well as determine global averages for mental health search term popularity for each public health measure. 

Six countries in our data set were chosen as focus: Brazil, India, Italy, Mexico, The United Sates, and New Zealand. We first focused on quantifying the relationship between one mental health burden, as quantified by search term frequency, and different types of restrictions. This was examined using multiple linear regression models where the response variable was mental illness search term frequency conditioned on all of the different COVID restrictions. This was done for all search terms for each of the six countries. Once all the regression models were created, any model with 3 or more significant p-values was selected for further evaluation.
...
```{r residualPlot1, warning=FALSE, message=FALSE, echo = FALSE, fig.height = 2.5, fig.width = 2.5}
...
```{r residualPlot2, warning=FALSE, message=FALSE, echo = FALSE, fig.height = 2.5, fig.width = 2.5}
...
```{r residualPlot3, warning=FALSE, message=FALSE, echo = FALSE, fig.height = 2.5, fig.width = 2.5}
...
```{r residualPlot4, warning=FALSE, message=FALSE, echo = FALSE, fig.height = 2.5, fig.width = 2.5}
...
```{r residualPlot5, warning=FALSE, message=FALSE, echo = FALSE, fig.height = 2.5, fig.width = 2.5}
...
```{r residualPlot6, warning=FALSE, message=FALSE, echo = FALSE, fig.height = 2.5, fig.width = 2.5}
...
```{r residualPlot7, warning=FALSE, message=FALSE, echo = FALSE, fig.height = 2.5, fig.width = 2.5}
